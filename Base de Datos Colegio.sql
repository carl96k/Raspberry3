...
create table horarios(
 ...
 constraint horarios_Fk2 foreign key (cod_modulo,cod_curso) references modulos
);

insert into horarios(cod_aula, dia_semana, hora_inicio, hora_fin,cod_modulo,cod_curso)
                     VALUES(02,'L','8:15','9:10',5,1);
insert into horarios VALUES(02,'L','9:10','10:05',5,1);
insert into horarios VALUES(02,'L','10:05','11:00',2,1);
insert into horarios VALUES(02,'L','11:30','12:25',2,1);
insert into horarios VALUES(01,'L','12:25','13:20',4,1);
insert into horarios VALUES(01,'L','13:20','14:15',4,1);
insert into horarios VALUES(02,'M','8:15','9:10',2,1);
insert into horarios VALUES(02,'M','9:10','10:05',2,1);
insert into horarios VALUES(02,'M','10:05','11:00',1,1);
insert into horarios VALUES(02,'M','11:30','12:25',1,1);
insert into horarios VALUES(03,'M','12:25','13:20',3,1);
insert into horarios VALUES(03,'M','13:20','14:15',3,1);
insert into horarios VALUES(01,'X','8:15','9:10',1,1);
insert into horarios VALUES(01,'X','9:10','10:05',1,1);
insert into horarios VALUES(02,'X','10:05','11:00',2,1);
insert into horarios VALUES(02,'X','11:30','12:25',2,1);
insert into horarios VALUES(01,'X','12:25','13:20',5,1);
insert into horarios VALUES(01,'X','13:20','14:15',5,1);
insert into horarios VALUES(01,'J','8:15','9:10',6,1);
insert into horarios VALUES(01,'J','9:10','10:05',2,1);
insert into horarios VALUES(02,'J','10:05','11:00',1,1);
insert into horarios VALUES(02,'J','11:30','12:25',1,1);
insert into horarios VALUES(02,'J','12:25','13:20',5,1);
insert into horarios VALUES(02,'J','13:20','14:15',5,1);
insert into horarios VALUES(01,'V','8:15','9:10',6,1);
insert into horarios VALUES(01,'V','9:10','10:05',6,1);
insert into horarios VALUES(02,'V','10:05','11:00',4,1);
insert into horarios VALUES(02,'V','11:30','12:25',4,1);
insert into horarios VALUES(01,'V','12:25','13:20',2,1);
insert into horarios VALUES(01,'V','13:20','14:15',3,1);
--
insert into horarios(cod_aula, dia_semana, hora_inicio, hora_fin,cod_modulo,cod_curso)
...
insert into alumnos values(2,'David','Franco','Laghezza');
...
insert into matricular (id_alumno,cod_modulo,cod_curso)
                        values(1,1,1);
...
create table modulos (
  ...
  constraint modulos_Pk primary key (cod_modulo,id_curso,fecha_inicio)
...
insert into modulos (cod_modulo,cod_curso,fecha_inicio,nombre,id_profesor)
            values (1,,1,to_date('15/09/2018')'Bases de Datos',1);
insert into modulos values(2,1,to_date('15/09/2018'),'Implantacion de Sistemas Operativos',3);
insert into modulos values(3,1,to_date('15/09/2018'),'Fundamentos Hardware',4);
insert into modulos values(4,1,to_date('15/09/2018'),'Lenguaje de Marcas',1);
insert into modulos values(5,1,to_date('15/09/2018'),'Planificacion y Administracion de Redes',4);
insert into modulos values(6,1,to_date('15/09/2018'),'Formacion y Orientacion Laboral',2);
insert into modulos values(7,2,to_date('15/09/2018'),'Empresa iniciativa emprendedora',2);
insert into modulos values(8,2,to_date('15/09/2018'),'Ampliacion de Sistemas Operativos',5);
insert into modulos values(9,2,to_date('15/09/2018'),'Administración de Base de Datos',1);
insert into modulos values(10,2,to_date('15/09/2018'),'Implementacion de aplicaciones web',1);
insert into modulos values(11,2,to_date('15/09/2018'),'Servicios de Red a Internet',4);
insert into modulos values(12,2,to_date('15/09/2018'),'Seguridad y Alta disponibilidad',4);
...
create table tareas (
  ...
  constraint tareas_Fk foreign key (cod_modulo,cod_curso) references modulos
);
...
create table notas(
  ...
  constraint notas_fk2 foreign key (cod_tarea,cod_modulo,cod_curso) references tareas
);
...
insert into notas values(3,,1,1,5.7);
...
insert into notas values(5,1,3,1,3.5);
...
insert into notas values(10,1,2,1,7.5);
